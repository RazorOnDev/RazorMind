          ...
          child: Column(
            ...
            children: [
              ...
              _ModeCard(
                ...
                onTap: () {
                  HapticFeedback.selectionClick();
                  context.push('/challenge?mode=survival');
                },
              ),
              const SizedBox(height: 12),
              ...
              _MarathonCard(
                ...
                onToggle: () {
                  HapticFeedback.selectionClick();
                  setState(() => _marathonExpanded = !_marathonExpanded);
                },
                onCategoryTap: (catId) {
                  HapticFeedback.selectionClick();
                  context.push('/challenge?mode=marathon&categoryId=$catId');
                },
              ),
            ],
          ),
...
// ---------------------------------------------------------------------------
// Marathon card (expandable with category chips)
// ---------------------------------------------------------------------------
                    ...
                    const Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 4),
                          Text(
                            'Domina una categoría de principio a fin.',
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: 13,
                              height: 1.4,
...
class _StatsBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Text(
        'Elige una categoría · Todas las preguntas',
        style: TextStyle(
          color: Colors.white,
          fontSize: 11,
          fontWeight: FontWeight.w600,
